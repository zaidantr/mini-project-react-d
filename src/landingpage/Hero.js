    ...
    <div className="container">
        <div className="flex flex-wrap">
            <div className="w-full self-center px-4 lg:w-1/2">
               ...
               md:text-xl mb-2">🪔Manage your own time<span className="block font-bold text-4xl leading-10 mt-1 mb-3 text-dark md:text-3xl lg:text-5xl">We made the best Pomodoro Timer to <span className="text-primary">Keep</span> you stay focus ⌛</span></h1>
